...
public class MovementManager extends Manager<SimulationRun, MovementAgent> {

	public MovementManager(SimulationRun simulation, MovementAgent agent) {
		super(Components.M_MOVEMENT, simulation, agent);
	}
